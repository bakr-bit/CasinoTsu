...
export default async function ConquestadorReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'conquestador');
  const casinoData = getCasino('conquestador');
