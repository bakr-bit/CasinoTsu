...
export default async function SushiCasinoReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'sushi-casino');
  const casinoData = getCasino('sushi-casino');
