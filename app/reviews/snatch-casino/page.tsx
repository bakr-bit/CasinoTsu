...
export default async function SnatchCasinoReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'snatch-casino');
  const casinoData = getCasino('snatch-casino');
