...
export const metadata: Metadata = {
  title: "2UP（2アップカジノ）レビュー：最大$2,000ボーナスと7,000種ゲームを徹底解説",
  description: "仮想通貨と日本円の両方でプレイ可能な2UPカジノを徹底レビュー。最大$2,000ボーナスや7,000種類以上のゲーム、安全性について詳しく解説します。",
};

export default async function N2upReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', '2up');
  const casinoData = getCasino('2up');
