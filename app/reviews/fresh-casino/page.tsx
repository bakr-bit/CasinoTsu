...
export default async function FreshCasinoReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'fresh-casino');
  const casinoData = getCasino('fresh-casino');
