...
export const metadata: Metadata = {
  title: "シャッフルカジノ（Shuffle）徹底レビュー：SHFLトークンと仮想通貨特化の魅力",
  description: "2023年ローンチの仮想通貨カジノ、シャッフルカジノ（Shuffle）を徹底解説。独自のSHFLトークン、豊富なゲーム、高還元率VIPプログラムの魅力を紹介します。",
};

export default async function ShuffleReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'shuffle');
  const casinoData = getCasino('shuffle');
