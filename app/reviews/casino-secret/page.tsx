...
export default async function CasinoSecretReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'casino-secret');
  const casinoData = getCasino('casino-secret');
