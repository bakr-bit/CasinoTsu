...
export default async function KingsOfSportReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'kings-of-sport');
  const casinoData = getCasino('kings-of-sport');
