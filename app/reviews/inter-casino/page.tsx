...
export default async function InterCasinoReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'inter-casino');
  const casinoData = getCasino('inter-casino');
