...
export default async function LuckyCasinoReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'lucky-casino');
  const casinoData = getCasino('lucky-casino');
