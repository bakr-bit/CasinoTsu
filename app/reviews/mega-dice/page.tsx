...
export const metadata: Metadata = {
  title: "メガダイス（Mega Dice）徹底解説：最大1BTCボーナスとTelegram連携が魅力の仮想通貨カジノ",
  description: "2023年登場の仮想通貨特化型カジノ、メガダイス（Mega Dice）を徹底レビュー。最大1BTCの豪華ボーナスや5,000種類以上のゲーム、Telegram連携の魅力を紹介します。",
};

export default async function MegaDiceReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'mega-dice');
  const casinoData = getCasino('mega-dice');
