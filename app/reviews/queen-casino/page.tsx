...
export default async function QueenCasinoReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'queen-casino');
  const casinoData = getCasino('queen-casino');
