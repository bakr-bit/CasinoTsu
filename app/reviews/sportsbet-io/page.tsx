...
export default async function SportsbetIoReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'sportsbet-io');
  const casinoData = getCasino('sportsbet-io');
