...
export const metadata: Metadata = {
  title: "ワンダーカジノ（Wonder Casino）のログイン方法、評判、入金不要ボーナスについて",
  description: "業界最速の出金スピードと豊富な仮想通貨ボーナスが魅力のワンダーカジノを徹底レビュー。登録方法、入金不要ボーナス、VIPプログラムの詳細を解説します。",
};

export default async function WonderCasinoReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'wonder-casino');
  const casinoData = getCasino('wonder-casino');
