...
export default async function GambolaCasinoReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'gambola-casino');
  const casinoData = getCasino('gambola-casino');
