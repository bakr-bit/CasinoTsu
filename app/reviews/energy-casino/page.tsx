...
export const metadata: Metadata = {
  title: "エナジーカジノ（Energy Casino）の評判を CasinoTsu が徹底解説（2025年最新版）",
  description: "海外で高い評価を得ていたエナジーカジノの安全性、ボーナス、ゲームラインナップを徹底レビュー。MGA/UKGCライセンスを持つ信頼性の高いカジノです。",
};

export default async function EnergyCasinoReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'energy-casino');
  const casinoData = getCasino('energy-casino');
