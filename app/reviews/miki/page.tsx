...
export const metadata: Metadata = {
  title: "Mikiカジノ（ミキカジノ）とは？ 特徴や強みなど！",
  description: "Mikiカジノの特徴、ウェルカムボーナス、ゲームラインナップ、決済方法、評判を網羅的に解説します。",
};

export default async function MikiReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'miki');
  const casinoData = getCasino('miki');
