...
export default async function BitcasinoIoReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'bitcasino-io');
  const casinoData = getCasino('bitcasino-io');
