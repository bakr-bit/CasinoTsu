...
export default async function VulkanVegasReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'vulkan-vegas');
  const casinoData = getCasino('vulkan-vegas');
