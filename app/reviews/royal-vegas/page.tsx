...
export const metadata: Metadata = {
  title: "ロイヤルベガス（Royal Vegas）徹底レビュー",
  description: "ロイヤルベガス（Royal Vegas）のボーナス、信頼性、ゲームラインナップをCasinoTsuが徹底解説。※2024年春に日本市場から撤退済み。",
};

export default async function RoyalVegasReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'royal-vegas');
  const casinoData = getCasino('royal-vegas');
