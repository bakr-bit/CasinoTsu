...
export default async function GoldenPandaReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'golden-panda');
  const casinoData = getCasino('golden-panda');
