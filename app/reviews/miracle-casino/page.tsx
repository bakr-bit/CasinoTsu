...
export default async function MiracleCasinoReviewPage() {
  const { content, frontmatter } = await loadMDX('reviews', 'miracle-casino');
  const casinoData = getCasino('miracle-casino');
