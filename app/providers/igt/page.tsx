...
export const metadata: Metadata = {
  ...
  description: "オンラインカジノのゲームプロバイダーの選び方、日本市場で人気のPlay'n GOやEvolutionなどの特徴、安全性、そして最新の技術情報をCasinoTsuが解説します。",
};

export default async function IgtProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'igt');
  const providerData = getProvider('igt');
