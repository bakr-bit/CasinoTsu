...
export const metadata: Metadata = {
  ...
  description: "オンラインカジノで遊べるゲームを開発・提供するソフトウェアプロバイダーについて、CasinoTsuが日本市場で人気の企業を厳選し、その特徴や代表作を徹底解説します。",
};

export default async function LightningBoxProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'lightning-box');
  const providerData = getProvider('lightning-box');
