...
export const metadata: Metadata = {
  ...
  description: "Manna Play（マナ・プレイ）の特徴、人気スロット、モバイル対応、そしてゲームが遊べるおすすめオンラインカジノをCasinoTsuが徹底解説します。",
};

export default async function MannaPlayProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'manna-play');
  const providerData = getProvider('manna-play');
