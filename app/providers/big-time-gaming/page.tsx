...
export default async function BigTimeGamingProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'big-time-gaming');
  const providerData = getProvider('big-time-gaming');
