...
export const metadata: Metadata = {
  title: "Spinmatic（スピンマティック）ゲームプロバイダーレビュー",
  description: "2017年に設立されたSpinmatic（スピンマティック）のゲームプロバイダーとしての特徴、人気スロット、遊べるカジノをCasinoTsuが徹底解説します。",
};

export default async function SpinmaticProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'spinmatic');
  const providerData = getProvider('spinmatic');
