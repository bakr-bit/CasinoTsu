...
export const metadata: Metadata = {
  title: "Novomatic (ノボマティック) - 信頼と実績の老舗ゲームプロバイダーを徹底解説",
  description: "1980年設立のオーストリア発ゲームプロバイダー、Novomatic（ノボマティック）を徹底解説。「Book of Ra」シリーズで知られる老舗の信頼性と人気ゲームを紹介します。",
};

export default async function NovomaticProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'novomatic');
  const providerData = getProvider('novomatic');
