...
export default async function ReelKingdomProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'reel-kingdom');
  const providerData = getProvider('reel-kingdom');
