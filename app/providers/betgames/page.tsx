...
export const metadata: Metadata = {
  ...
  description: "ライブカジノ専門プロバイダーBetGames（ベットゲームズ）のゲームラインナップ、安全性、そしてTwain Sportなどのユニークなコンテンツを徹底解説します。",
};

export default async function BetgamesProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'betgames');
  const providerData = getProvider('betgames');
