...
export default async function QuikGamingProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'quik-gaming');
  const providerData = getProvider('quik-gaming');
