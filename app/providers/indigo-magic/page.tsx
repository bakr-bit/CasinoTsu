...
export default async function IndigoMagicProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'indigo-magic');
  const providerData = getProvider('indigo-magic');
