...
export const metadata: Metadata = {
  ...
  description: "ランドカジノからのライブ配信に特化したオーセンティック・ゲーミング（Authentic Gaming）の特徴、人気ゲーム、そしてプレイできるおすすめオンラインカジノを徹底解説します。",
};

export default async function AuthenticGamingProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'authentic-gaming');
  const providerData = getProvider('authentic-gaming');
