...
export default async function SpinomenalProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'spinomenal');
  const providerData = getProvider('spinomenal');
