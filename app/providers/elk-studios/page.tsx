...
export const metadata: Metadata = {
  title: "Elk Studios：革新的な機能と美しいデザインでプレイヤーを魅了するスロットプロバイダー",
  description: "スウェーデン発のプロバイダー、Elk Studios（エルクスタジオ）のゲームの特徴、人気スロット、安全性、そして革新的なX-iter™機能についてCasinoTsuが徹底レビューします。",
};

export default async function ElkStudiosProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'elk-studios');
  const providerData = getProvider('elk-studios');
