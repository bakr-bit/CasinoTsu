...
export const metadata: Metadata = {
  ...
  description: "Nolimit City（ノーリミット・シティ）の概要、人気スロット、革新的なxWaysやxNudge機能、そしてゲームがプレイできるおすすめカジノを徹底解説します。",
};

export default async function NolimitCityProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'nolimit-city');
  const providerData = getProvider('nolimit-city');
