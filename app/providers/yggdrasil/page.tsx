...
export default async function YggdrasilProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'yggdrasil');
  const providerData = getProvider('yggdrasil');
