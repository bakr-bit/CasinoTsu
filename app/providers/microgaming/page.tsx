...
export default async function MicrogamingProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'microgaming');
  const providerData = getProvider('microgaming');
