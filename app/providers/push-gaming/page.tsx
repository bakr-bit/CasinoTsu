...
export default async function PushGamingProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'push-gaming');
  const providerData = getProvider('push-gaming');
