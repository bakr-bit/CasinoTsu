...
export default async function GoldenHeroGamesProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'golden-hero-games');
  const providerData = getProvider('golden-hero-games');
