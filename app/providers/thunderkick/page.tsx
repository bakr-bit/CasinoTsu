...
export const metadata: Metadata = {
  ...
  description: "2012年設立のスウェーデン発プロバイダー、サンダーキック（Thunderkick）を徹底レビュー。ユニークなテーマと高ボラティリティが魅力のゲーム群を紹介します。",
};

export default async function ThunderkickProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'thunderkick');
  const providerData = getProvider('thunderkick');
