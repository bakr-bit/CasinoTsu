...
export default async function EvolutionProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'Evolution');
  const providerData = getProvider('Evolution');
