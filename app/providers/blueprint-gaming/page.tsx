...
export const metadata: Metadata = {
  ...
  description: "Blueprint Gaming（ブループリントゲーミング）の特徴、人気スロット、Jackpot Kingシステム、そしてゲームが遊べるおすすめオンラインカジノを徹底解説します。",
};

export default async function BlueprintGamingProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'blueprint-gaming');
  const providerData = getProvider('blueprint-gaming');
