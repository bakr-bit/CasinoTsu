...
export default async function VivoGamingProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'vivo-gaming');
  const providerData = getProvider('vivo-gaming');
