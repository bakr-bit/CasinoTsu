...
export const metadata: Metadata = {
  title: "Print Studios レビュー【2025年版】",
  description: "2020年設立の革新的なスロットプロバイダー、Print Studios（プリントスタジオ）を徹底レビュー。SuperSpinners™など独自機能を持つ人気ゲームや遊べるカジノを紹介します。",
};

export default async function PrintStudiosProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'print-studios');
  const providerData = getProvider('print-studios');
