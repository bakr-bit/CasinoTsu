...
export const metadata: Metadata = {
  title: "ELA Games（エラ・ゲームズ）の評判と最新ゲーム情報",
  description: "2021年に設立された新進気鋭のプロバイダー、ELA Games（エラ・ゲームズ）の特徴やおすすめスロット、遊べるオンラインカジノを徹底解説します。",
};

export default async function ElaGamesProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'ela-games');
  const providerData = getProvider('ela-games');
