...
export default async function BoomingGamesProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'booming-games');
  const providerData = getProvider('booming-games');
