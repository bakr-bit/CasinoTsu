...
export default async function PragmaticPlayProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'pragmatic-play');
  const providerData = getProvider('pragmatic-play');
