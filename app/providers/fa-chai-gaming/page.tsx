...
export default async function FaChaiGamingProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'fa-chai-gaming');
  const providerData = getProvider('fa-chai-gaming');
