...
export const metadata: Metadata = {
  ...
  description: "オンラインカジノのゲームプロバイダーについて、日本市場で人気の企業の特徴、おすすめゲーム、安全性、そして選び方をCasinoTsuが徹底解説します。",
};

export default async function GreentubeProviderPage() {
  const { content, frontmatter } = await loadMDX('providers', 'greentube');
  const providerData = getProvider('greentube');
