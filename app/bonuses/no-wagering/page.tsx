...
export const metadata: Metadata = {
  title: "【2025年最新版】出金条件なしカジノボーナス完全ガイド",
  description: "賭け条件なし（出金条件なし）で遊べるオンラインカジノボーナスを徹底解説。日本のプレイヤー向けに最新のお得な情報を紹介します。",
};

export default async function NoWageringBonusPage() {
  const { content, frontmatter, headings } = await loadMDX('bonuses', 'no-wagering');
