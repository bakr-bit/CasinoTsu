...
export const metadata: Metadata = {
  title: "VIPカジノボーナス完全ガイド【2025年最新版】",
  description: "オンラインカジノのVIPプログラムの仕組み、豪華な特典、ランクアップのコツ、そして日本プレイヤー向けの安全なVIPカジノを徹底解説します。",
};

export default async function VipBonusPage() {
  const { content, frontmatter, headings } = await loadMDX('bonuses', 'vip');
