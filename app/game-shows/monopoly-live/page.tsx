...
export const metadata: Metadata = {
  title: "【モノポリー ライブ】日本向け完全ガイド",
  description: "モノポリー ライブ（Monopoly Live）の遊び方、日本円での賭け方、安全性、おすすめカジノを徹底解説します。",
};

export default async function MonopolyLiveGameShowPage() {
  const { content, frontmatter } = await loadMDX('game-shows', 'monopoly-live');
