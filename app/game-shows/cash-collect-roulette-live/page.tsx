...
export const metadata: Metadata = {
  ...
  description: "プレイテックが提供する「キャッシュ・コレクト・ルーレット・ライブ」のルール、ボーナス機能、日本からのプレイ方法を徹底解説します。",
};

export default async function CashCollectRouletteLiveGameShowPage() {
  const { content, frontmatter } = await loadMDX('game-shows', 'cash-collect-roulette-live');
