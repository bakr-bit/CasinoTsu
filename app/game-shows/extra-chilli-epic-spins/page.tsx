...
export const metadata: Metadata = {
  title: "スーパーチリペッパー・エピックスピンズ（Extra Chilli Epic Spins）完全ガイド",
  description: "Evolution社の人気メガウェイズスロット『エクストラチリ』をベースにしたライブゲームショー「スーパーチリペッパー・エピックスピンズ」の遊び方、RTP、ボーナスフィーチャーを徹底解説します。",
};

export default async function ExtraChilliEpicSpinsGameShowPage() {
  const { content, frontmatter } = await loadMDX('game-shows', 'extra-chilli-epic-spins');
