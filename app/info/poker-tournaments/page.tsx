...
export default async function PokerTournamentsInfoPage() {
  const { content, frontmatter } = await loadMDX('info', 'poker-tournaments');
  const infoData = getInfo('poker-tournaments');
