...
export default async function InterestingPokerFactsInfoPage() {
  const { content, frontmatter } = await loadMDX('info', 'interesting-poker-facts');
  const infoData = getInfo('interesting-poker-facts');
