...
export default async function BiggestGamblingCountriesInfoPage() {
  const { content, frontmatter } = await loadMDX('info', 'biggest-gambling-countries');
  const infoData = getInfo('biggest-gambling-countries');
