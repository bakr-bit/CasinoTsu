...
export default async function N10MistakesInVegasInfoPage() {
  const { content, frontmatter } = await loadMDX('info', '10-mistakes-in-vegas');
  const infoData = getInfo('10-mistakes-in-vegas');
