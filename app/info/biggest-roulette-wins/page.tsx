...
export default async function BiggestRouletteWinsInfoPage() {
  const { content, frontmatter } = await loadMDX('info', 'biggest-roulette-wins');
  const infoData = getInfo('biggest-roulette-wins');
