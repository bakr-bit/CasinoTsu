...
export default async function PokerSkillsAndBusinessInfoPage() {
  const { content, frontmatter } = await loadMDX('info', 'poker-skills-and-business');
  const infoData = getInfo('poker-skills-and-business');
