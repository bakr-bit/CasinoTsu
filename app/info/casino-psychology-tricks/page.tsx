...
export default async function CasinoPsychologyTricksInfoPage() {
  const { content, frontmatter } = await loadMDX('info', 'casino-psychology-tricks');
  const infoData = getInfo('casino-psychology-tricks');
