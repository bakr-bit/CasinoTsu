...
export default async function FemalePokerplayersInfoPage() {
  const { content, frontmatter } = await loadMDX('info', 'female-pokerplayers');
  const infoData = getInfo('female-pokerplayers');
