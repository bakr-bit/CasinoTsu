...
export const metadata: Metadata = {
  ...
  description: "CasinoTsu は、カジノにまつわるギネス記録をまとめました。世界レベルの記録は、やはり格別ですね。",
};

export default async function GuinnessRecordsInfoPage() {
  const { content, frontmatter } = await loadMDX('info', 'guinness-records');
  const infoData = getInfo('guinness-records');
