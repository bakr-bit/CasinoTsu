...
export default async function PokerPlayersCelebInfoPage() {
  const { content, frontmatter } = await loadMDX('info', 'poker-players-celeb');
  const infoData = getInfo('poker-players-celeb');
