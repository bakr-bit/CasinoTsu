...
export default async function HistoryOfTheSlotsInfoPage() {
  const { content, frontmatter } = await loadMDX('info', 'history-of-the-slots');
  const infoData = getInfo('history-of-the-slots');
