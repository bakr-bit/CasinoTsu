...
export default async function N5richestPokerPlayersInfoPage() {
  const { content, frontmatter } = await loadMDX('info', '5richest-poker-players');
  const infoData = getInfo('5richest-poker-players');
