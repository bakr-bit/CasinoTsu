...
export default async function InactiveAccountInfoPage() {
  const { content, frontmatter } = await loadMDX('info', 'inactive-account');
  const infoData = getInfo('inactive-account');
