...
export default async function CasinosInTheWorldInfoPage() {
  const { content, frontmatter } = await loadMDX('info', 'casinos-in-the-world');
  const infoData = getInfo('casinos-in-the-world');
