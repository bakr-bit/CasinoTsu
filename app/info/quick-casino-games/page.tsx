...
export default async function QuickCasinoGamesInfoPage() {
  const { content, frontmatter } = await loadMDX('info', 'quick-casino-games');
  const infoData = getInfo('quick-casino-games');
