...
export default async function N7TypesOfGamblersInfoPage() {
  const { content, frontmatter } = await loadMDX('info', '7-types-of-gamblers');
  const infoData = getInfo('7-types-of-gamblers');
