...
export default async function EvolutionSuperSpeedBaccaratLiveCasinoPage() {
  const { content, frontmatter } = await loadMDX('live-casino', 'evolution-super-speed-baccarat');
  const liveCasinoData = getLiveCasino('evolution-super-speed-baccarat');
