...
export const metadata: Metadata = {
  ...
  description: "ジャパニーズ・ルーレットの遊び方、ルール、日本語対応カジノ、入出金方法、RTP、セキュリティ情報を網羅した完全ガイド。Evolution Gamingが提供する日本人向けライブルーレットの魅力を徹底解説。",
};

export default async function JapaneseRouletteLiveCasinoPage() {
  const { content, frontmatter } = await loadMDX('live-casino', 'japanese-roulette');
  const liveCasinoData = getLiveCasino('japanese-roulette');
