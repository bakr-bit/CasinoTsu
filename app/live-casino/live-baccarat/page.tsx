...
export default async function LiveBaccaratLiveCasinoPage() {
  const { content, frontmatter } = await loadMDX('live-casino', 'live-baccarat');
  const liveCasinoData = getLiveCasino('live-baccarat');
