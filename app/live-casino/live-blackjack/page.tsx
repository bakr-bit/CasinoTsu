...
export default async function LiveBlackjackLiveCasinoPage() {
  const { content, frontmatter } = await loadMDX('live-casino', 'live-blackjack');
  const liveCasinoData = getLiveCasino('live-blackjack');
