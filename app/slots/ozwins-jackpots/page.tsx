...
export default async function OzwinsJackpotsSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'ozwins-jackpots');
  const slotData = getSlot('ozwins-jackpots');
