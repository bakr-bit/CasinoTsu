...
export default async function StarburstXxxtremeSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'starburst-xxxtreme');
  const slotData = getSlot('starburst-xxxtreme');
