...
export default async function FairytaleLegendsHanselGretelSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'fairytale-legends-hansel-gretel');
  const slotData = getSlot('fairytale-legends-hansel-gretel');
