...
export default async function GatesOfOlympusSuperScatterSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'gates-of-olympus-super-scatter');
  const slotData = getSlot('gates-of-olympus-super-scatter');
