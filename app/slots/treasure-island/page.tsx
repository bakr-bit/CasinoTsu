...
export default async function TreasureIslandSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'treasure-island');
  const slotData = getSlot('treasure-island');
