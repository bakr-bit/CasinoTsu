...
export default async function VampiresGoneWildSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'vampires-gone-wild');
  const slotData = getSlot('vampires-gone-wild');
