...
export const metadata: Metadata = {
  title: "高ボラティリティスロット｜オンラインスロット攻略",
  description: "高ボラティリティスロットは、大きな配当を狙えるが当たりの頻度は低めのスロットです。",
};

export default async function HighVolatilityPage() {
  const { content, frontmatter } = await loadMDX('slots-categories', 'high-volatility');
