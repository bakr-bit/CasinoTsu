...
export default async function GodsOfOlympusIiiMegawaysSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'gods-of-olympus-iii-megaways');
  const slotData = getSlot('gods-of-olympus-iii-megaways');
