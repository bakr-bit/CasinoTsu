...
export default async function FloatingDragonNewYearFestivalSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'floating-dragon-new-year-festival');
  const slotData = getSlot('floating-dragon-new-year-festival');
