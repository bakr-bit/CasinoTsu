...
export default async function BigBassBonanzaSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'big-bass-bonanza');
  const slotData = getSlot('big-bass-bonanza');
