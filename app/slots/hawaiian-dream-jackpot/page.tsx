...
export default async function HawaiianDreamJackpotSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'hawaiian-dream-jackpot');
  const slotData = getSlot('hawaiian-dream-jackpot');
