...
export default async function TempleTumble2DreamDropSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'temple-tumble-2-dream-drop');
  const slotData = getSlot('temple-tumble-2-dream-drop');
