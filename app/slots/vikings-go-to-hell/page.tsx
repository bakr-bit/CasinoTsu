...
export default async function VikingsGoToHellSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'vikings-go-to-hell');
  const slotData = getSlot('vikings-go-to-hell');
