...
export default async function RaigekiRisingX30SlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'raigeki-rising-x30');
  const slotData = getSlot('raigeki-rising-x30');
