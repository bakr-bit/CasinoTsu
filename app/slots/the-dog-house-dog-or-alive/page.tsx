...
export default async function TheDogHouseDogOrAliveSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'the-dog-house-dog-or-alive');
  const slotData = getSlot('the-dog-house-dog-or-alive');
