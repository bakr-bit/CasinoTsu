...
export default async function EsqueletoExplosivo3SlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'esqueleto-explosivo-3');
  const slotData = getSlot('esqueleto-explosivo-3');
