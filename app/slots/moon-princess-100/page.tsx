...
export default async function MoonPrincess100SlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'moon-princess-100');
  const slotData = getSlot('moon-princess-100');
