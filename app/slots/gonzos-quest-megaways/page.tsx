...
export default async function GonzosQuestMegawaysSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'gonzos-quest-megaways');
  const slotData = getSlot('gonzos-quest-megaways');
