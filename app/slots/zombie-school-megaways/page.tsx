...
export default async function ZombieSchoolMegawaysSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'zombie-school-megaways');
  const slotData = getSlot('zombie-school-megaways');
