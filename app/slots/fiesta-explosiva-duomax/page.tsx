...
export default async function FiestaExplosivaDuomaxSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'fiesta-explosiva-duomax');
  const slotData = getSlot('fiesta-explosiva-duomax');
