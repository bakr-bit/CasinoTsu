...
export default async function TwinSpinDeluxeSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'twin-spin-deluxe');
  const slotData = getSlot('twin-spin-deluxe');
