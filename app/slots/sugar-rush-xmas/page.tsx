...
export default async function SugarRushXmasSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'sugar-rush-xmas');
  const slotData = getSlot('sugar-rush-xmas');
