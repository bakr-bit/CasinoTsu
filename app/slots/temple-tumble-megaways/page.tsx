...
export default async function TempleTumbleMegawaysSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'temple-tumble-megaways');
  const slotData = getSlot('temple-tumble-megaways');
