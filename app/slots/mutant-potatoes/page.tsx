...
export default async function MutantPotatoesSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'mutant-potatoes');
  const slotData = getSlot('mutant-potatoes');
