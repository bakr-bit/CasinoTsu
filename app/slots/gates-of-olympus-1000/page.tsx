...
export default async function GatesOfOlympus1000SlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'gates-of-olympus-1000');
  const slotData = getSlot('gates-of-olympus-1000');
