...
export default async function MimiAndTheMagicStaffSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'mimi-and-the-magic-staff');
  const slotData = getSlot('mimi-and-the-magic-staff');
