...
export default async function JackpotRaidersSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'jackpot-raiders');
  const slotData = getSlot('jackpot-raiders');
