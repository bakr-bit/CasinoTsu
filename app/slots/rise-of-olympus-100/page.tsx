...
export default async function RiseOfOlympus100SlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'rise-of-olympus-100');
  const slotData = getSlot('rise-of-olympus-100');
