...
export default async function BigBassSplashSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'big-bass-splash');
  const slotData = getSlot('big-bass-splash');
