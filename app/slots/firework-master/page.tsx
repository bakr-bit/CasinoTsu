...
export default async function FireworkMasterSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'firework-master');
  const slotData = getSlot('firework-master');
