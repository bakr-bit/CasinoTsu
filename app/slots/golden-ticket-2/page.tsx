...
export default async function GoldenTicket2SlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'golden-ticket-2');
  const slotData = getSlot('golden-ticket-2');
