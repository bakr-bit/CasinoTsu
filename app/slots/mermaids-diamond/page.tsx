...
export default async function MermaidsDiamondSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'mermaids-diamond');
  const slotData = getSlot('mermaids-diamond');
