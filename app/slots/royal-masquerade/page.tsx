...
export default async function RoyalMasqueradeSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'royal-masquerade');
  const slotData = getSlot('royal-masquerade');
