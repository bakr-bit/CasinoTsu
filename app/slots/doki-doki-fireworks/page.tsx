...
export default async function DokiDokiFireworksSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'doki-doki-fireworks');
  const slotData = getSlot('doki-doki-fireworks');
