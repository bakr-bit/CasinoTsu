...
export default async function HalloweenBonanzaSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'halloween-bonanza');
  const slotData = getSlot('halloween-bonanza');
