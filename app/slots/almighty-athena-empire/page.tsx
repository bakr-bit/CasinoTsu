...
export default async function AlmightyAthenaEmpireSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'almighty-athena-empire');
  const slotData = getSlot('almighty-athena-empire');
