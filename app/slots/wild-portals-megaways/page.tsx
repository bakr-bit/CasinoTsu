...
export default async function WildPortalsMegawaysSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'wild-portals-megaways');
  const slotData = getSlot('wild-portals-megaways');
