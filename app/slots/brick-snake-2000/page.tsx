...
export default async function BrickSnake2000SlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'brick-snake-2000');
  const slotData = getSlot('brick-snake-2000');
