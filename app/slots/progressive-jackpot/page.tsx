...
export const metadata: Metadata = {
  title: "プログレッシブジャックポット｜オンラインスロット攻略",
  description: "プレイするたびにジャックポット賞金が積み上がる、夢の一攫千金スロット。",
};

export default async function ProgressiveJackpotPage() {
  const { content, frontmatter } = await loadMDX('slots-categories', 'progressive-jackpot');
