...
export default async function SectionViiiRiseOfTheDamnedSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'section-viii-rise-of-the-damned');
  const slotData = getSlot('section-viii-rise-of-the-damned');
