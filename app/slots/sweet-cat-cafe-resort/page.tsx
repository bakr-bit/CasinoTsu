...
export default async function SweetCatCafeResortSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'sweet-cat-cafe-resort');
  const slotData = getSlot('sweet-cat-cafe-resort');
