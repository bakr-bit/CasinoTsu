...
export default async function MexomaxMultimaxSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'mexomax-multimax');
  const slotData = getSlot('mexomax-multimax');
