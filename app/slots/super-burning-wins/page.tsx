...
export default async function SuperBurningWinsSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'super-burning-wins');
  const slotData = getSlot('super-burning-wins');
