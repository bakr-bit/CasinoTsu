...
export default async function SweetBonanzaXmasSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'sweet-bonanza-xmas');
  const slotData = getSlot('sweet-bonanza-xmas');
