...
export default async function AikoAndTheWindSpiritSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'aiko-and-the-wind-spirit');
  const slotData = getSlot('aiko-and-the-wind-spirit');
