...
export default async function MoonPrincessTrinitySlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'moon-princess-trinity');
  const slotData = getSlot('moon-princess-trinity');
