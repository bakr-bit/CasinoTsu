...
export default async function BookOfDemiGods2SlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'book-of-demi-gods-2');
  const slotData = getSlot('book-of-demi-gods-2');
