...
export default async function CrackTheBankHoldAndWinSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'crack-the-bank-hold-and-win');
  const slotData = getSlot('crack-the-bank-hold-and-win');
