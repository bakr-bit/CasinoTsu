...
export default async function MisaAugurSweetieSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'misa-augur-sweetie');
  const slotData = getSlot('misa-augur-sweetie');
