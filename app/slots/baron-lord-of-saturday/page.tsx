...
export default async function BaronLordOfSaturdaySlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'baron-lord-of-saturday');
  const slotData = getSlot('baron-lord-of-saturday');
