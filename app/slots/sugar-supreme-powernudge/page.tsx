...
export default async function SugarSupremePowernudgeSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'sugar-supreme-powernudge');
  const slotData = getSlot('sugar-supreme-powernudge');
