...
export default async function LuckyValentineSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'lucky-valentine');
  const slotData = getSlot('lucky-valentine');
