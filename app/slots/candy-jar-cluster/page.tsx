...
export default async function CandyJarClusterSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'candy-jar-cluster');
  const slotData = getSlot('candy-jar-cluster');
