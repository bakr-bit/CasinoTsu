...
export default async function MagicMirrorDeluxe2SlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'magic-mirror-deluxe-2');
  const slotData = getSlot('magic-mirror-deluxe-2');
