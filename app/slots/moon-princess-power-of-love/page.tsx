...
export default async function MoonPrincessPowerOfLoveSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'moon-princess-power-of-love');
  const slotData = getSlot('moon-princess-power-of-love');
