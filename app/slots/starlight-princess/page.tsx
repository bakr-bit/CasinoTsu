...
export default async function StarlightPrincessSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'starlight-princess');
  const slotData = getSlot('starlight-princess');
