...
export const metadata: Metadata = {
  title: "中ボラティリティスロット｜オンラインスロット攻略",
  description: "中ボラティリティスロットは、バランスの取れた配当頻度と配当額を持つスロットです。",
};

export default async function MediumVolatilityPage() {
  const { content, frontmatter } = await loadMDX('slots-categories', 'medium-volatility');
