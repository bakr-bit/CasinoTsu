...
export default async function VikingRunecraftSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'viking-runecraft');
  const slotData = getSlot('viking-runecraft');
