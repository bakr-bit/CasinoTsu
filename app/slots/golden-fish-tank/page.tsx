...
export default async function GoldenFishTankSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'golden-fish-tank');
  const slotData = getSlot('golden-fish-tank');
