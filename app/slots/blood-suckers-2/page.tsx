...
export default async function BloodSuckers2SlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'blood-suckers-2');
  const slotData = getSlot('blood-suckers-2');
