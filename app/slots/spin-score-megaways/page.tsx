...
export default async function SpinScoreMegawaysSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'spin-score-megaways');
  const slotData = getSlot('spin-score-megaways');
