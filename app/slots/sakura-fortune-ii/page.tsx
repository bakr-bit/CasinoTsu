...
export default async function SakuraFortuneIiSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'sakura-fortune-ii');
  const slotData = getSlot('sakura-fortune-ii');
