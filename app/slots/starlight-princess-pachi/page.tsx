...
export default async function StarlightPrincessPachiSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'starlight-princess-pachi');
  const slotData = getSlot('starlight-princess-pachi');
