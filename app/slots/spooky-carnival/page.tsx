...
export default async function SpookyCarnivalSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'spooky-carnival');
  const slotData = getSlot('spooky-carnival');
