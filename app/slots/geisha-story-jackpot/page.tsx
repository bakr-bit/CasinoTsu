...
export default async function GeishaStoryJackpotSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'geisha-story-jackpot');
  const slotData = getSlot('geisha-story-jackpot');
