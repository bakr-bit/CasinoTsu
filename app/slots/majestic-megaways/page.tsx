...
export default async function MajesticMegawaysSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'majestic-megaways');
  const slotData = getSlot('majestic-megaways');
