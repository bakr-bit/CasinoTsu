...
export default async function SweetBonanza1000SlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'sweet-bonanza-1000');
  const slotData = getSlot('sweet-bonanza-1000');
