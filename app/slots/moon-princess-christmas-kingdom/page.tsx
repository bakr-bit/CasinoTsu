...
export default async function MoonPrincessChristmasKingdomSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'moon-princess-christmas-kingdom');
  const slotData = getSlot('moon-princess-christmas-kingdom');
