...
export default async function SantasXmasRushSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'santas-xmas-rush');
  const slotData = getSlot('santas-xmas-rush');
