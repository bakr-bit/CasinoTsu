...
export default async function InvadingVegasRevengeOnMarsSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'invading-vegas-revenge-on-mars');
  const slotData = getSlot('invading-vegas-revenge-on-mars');
