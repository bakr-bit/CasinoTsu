...
export default async function MagicMaidCafeSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'magic-maid-cafe');
  const slotData = getSlot('magic-maid-cafe');
