...
export default async function GatesOfOlympusSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'gates-of-olympus');
  const slotData = getSlot('gates-of-olympus');
