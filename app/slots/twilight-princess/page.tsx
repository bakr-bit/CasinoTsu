...
export default async function TwilightPrincessSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'twilight-princess');
  const slotData = getSlot('twilight-princess');
