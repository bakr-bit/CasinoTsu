...
export default async function JungleSpiritCallOfTheWildSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'jungle-spirit-call-of-the-wild');
  const slotData = getSlot('jungle-spirit-call-of-the-wild');
