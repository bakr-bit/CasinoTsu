...
export default async function VaultCrackerMegawaysSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'vault-cracker-megaways');
  const slotData = getSlot('vault-cracker-megaways');
