...
export default async function MightyWildPantherGrandGoldEditionSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'mighty-wild-panther-grand-gold-edition');
  const slotData = getSlot('mighty-wild-panther-grand-gold-edition');
