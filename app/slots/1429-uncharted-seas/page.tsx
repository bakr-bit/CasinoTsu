...
export default async function N1429UnchartedSeasSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', '1429-uncharted-seas');
  const slotData = getSlot('1429-uncharted-seas');
