...
export default async function GravityBonanzaSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'gravity-bonanza');
  const slotData = getSlot('gravity-bonanza');
