...
export default async function ChristmasBigBassBonanzaSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'christmas-big-bass-bonanza');
  const slotData = getSlot('christmas-big-bass-bonanza');
