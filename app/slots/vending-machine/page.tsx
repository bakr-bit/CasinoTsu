...
export default async function VendingMachineSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'vending-machine');
  const slotData = getSlot('vending-machine');
