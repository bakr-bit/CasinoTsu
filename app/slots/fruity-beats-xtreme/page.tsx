...
export default async function FruityBeatsXtremeSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'fruity-beats-xtreme');
  const slotData = getSlot('fruity-beats-xtreme');
