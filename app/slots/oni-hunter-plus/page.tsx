...
export default async function OniHunterPlusSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'oni-hunter-plus');
  const slotData = getSlot('oni-hunter-plus');
