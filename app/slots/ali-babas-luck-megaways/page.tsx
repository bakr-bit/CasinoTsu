...
export default async function AliBabasLuckMegawaysSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'ali-babas-luck-megaways');
  const slotData = getSlot('ali-babas-luck-megaways');
