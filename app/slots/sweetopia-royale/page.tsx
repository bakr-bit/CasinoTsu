...
export default async function SweetopiaRoyaleSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'sweetopia-royale');
  const slotData = getSlot('sweetopia-royale');
