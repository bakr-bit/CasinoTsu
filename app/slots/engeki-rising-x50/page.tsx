...
export default async function EngekiRisingX50SlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'engeki-rising-x50');
  const slotData = getSlot('engeki-rising-x50');
