...
export default async function LuckyNekoGigabloxSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'lucky-neko-gigablox');
  const slotData = getSlot('lucky-neko-gigablox');
