...
export default async function StarlightChristmasSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'starlight-christmas');
  const slotData = getSlot('starlight-christmas');
