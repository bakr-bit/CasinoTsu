...
export default async function SugarRush1000SlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'sugar-rush-1000');
  const slotData = getSlot('sugar-rush-1000');
