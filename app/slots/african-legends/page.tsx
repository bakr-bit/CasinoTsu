...
export default async function AfricanLegendsSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'african-legends');
  const slotData = getSlot('african-legends');
