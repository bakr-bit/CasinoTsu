...
export default async function PlanetOfTheApesSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'planet-of-the-apes');
  const slotData = getSlot('planet-of-the-apes');
