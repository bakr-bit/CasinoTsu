...
export default async function RichWildeAndTheTomeOfMadnessSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'rich-wilde-and-the-tome-of-madness');
  const slotData = getSlot('rich-wilde-and-the-tome-of-madness');
