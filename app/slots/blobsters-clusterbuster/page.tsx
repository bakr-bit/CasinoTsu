...
export default async function BlobstersClusterbusterSlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'blobsters-clusterbuster');
  const slotData = getSlot('blobsters-clusterbuster');
