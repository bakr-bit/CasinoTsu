...
export default async function BookOfRaDeluxe6SlotPage() {
  const { content, frontmatter } = await loadMDX('slots', 'book-of-ra-deluxe-6');
  const slotData = getSlot('book-of-ra-deluxe-6');
