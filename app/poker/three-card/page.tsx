...
export const metadata: Metadata = {
  ...
  description: "スリーカードポーカーの基本ルール、おすすめの攻略法、日本人向けオンラインカジノの選び方まで、私たちCasinoTsuがわかりやすく解説します。",
};

export default async function ThreeCardPokerPage() {
  const { content, frontmatter } = await loadMDX('poker', 'three-card');
  const pokerData = getPoker('three-card');
