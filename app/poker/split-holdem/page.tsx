...
export const metadata: Metadata = {
  ...
  description: "スプリット・ホールデムのルール、日本のオンラインカジノでのプレイ方法、入出金、本人確認、法律、責任あるプレイについて解説します。私たちCasinoTsuが、このユニークなポーカーの楽しみ方をご紹介します。",
};

export default async function SplitHoldemPokerPage() {
  const { content, frontmatter } = await loadMDX('poker', 'split-holdem');
  const pokerData = getPoker('split-holdem');
