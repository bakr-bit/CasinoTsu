...
export default async function BadCheckReasonsGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'bad-check-reasons');
  const guideData = getGuide('bad-check-reasons');
