...
export default async function HowToBePokerProGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'how-to-be-poker-pro');
  const guideData = getGuide('how-to-be-poker-pro');
