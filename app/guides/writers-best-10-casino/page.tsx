...
export default async function WritersBest10CasinoGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'writers-best-10-casino');
  const guideData = getGuide('writers-best-10-casino');
