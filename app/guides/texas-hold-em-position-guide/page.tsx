...
export default async function TexasHoldEmPositionGuideGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'texas-hold-em-position-guide');
  const guideData = getGuide('texas-hold-em-position-guide');
