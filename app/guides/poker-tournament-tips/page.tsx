...
export default async function PokerTournamentTipsGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'poker-tournament-tips');
  const guideData = getGuide('poker-tournament-tips');
