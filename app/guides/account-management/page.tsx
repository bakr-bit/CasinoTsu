...
export default async function AccountManagementGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'account-management');
  const guideData = getGuide('account-management');
