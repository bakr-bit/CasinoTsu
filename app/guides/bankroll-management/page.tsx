...
export default async function BankrollManagementGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'bankroll-management');
  const guideData = getGuide('bankroll-management');
