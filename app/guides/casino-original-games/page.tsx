...
export default async function CasinoOriginalGamesGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'casino-original-games');
  const guideData = getGuide('casino-original-games');
