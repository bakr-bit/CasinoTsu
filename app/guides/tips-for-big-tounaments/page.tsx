...
export default async function TipsForBigTounamentsGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'tips-for-big-tounaments');
  const guideData = getGuide('tips-for-big-tounaments');
