...
export default async function CasinoSkillGamesGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'casino-skill-games');
  const guideData = getGuide('casino-skill-games');
