...
export default async function HowCasinoAttractHighRollersGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'how-casino-attract-high-rollers');
  const guideData = getGuide('how-casino-attract-high-rollers');
