...
export default async function BreakFreeDownswingGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'break-free-downswing');
  const guideData = getGuide('break-free-downswing');
