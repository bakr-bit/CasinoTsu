...
export default async function SideBetPokerGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'side-bet-poker');
  const guideData = getGuide('side-bet-poker');
