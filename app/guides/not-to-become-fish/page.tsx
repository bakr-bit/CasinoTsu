...
export default async function NotToBecomeFishGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'not-to-become-fish');
  const guideData = getGuide('not-to-become-fish');
