...
export default async function WageringRequirementsGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'wagering-requirements');
  const guideData = getGuide('wagering-requirements');
