...
export default async function PreflopMistakesGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'preflop-mistakes');
  const guideData = getGuide('preflop-mistakes');
