...
export default async function CasinoBestGameOddsGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'casino-best-game-odds');
  const guideData = getGuide('casino-best-game-odds');
