...
export default async function PokerHandsEvaluationGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'poker-hands-evaluation');
  const guideData = getGuide('poker-hands-evaluation');
