...
export default async function CasinoEnglishVocabularyGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'casino-english-vocabulary');
  const guideData = getGuide('casino-english-vocabulary');
