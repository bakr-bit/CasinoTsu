...
export default async function FreeCasinoGamesGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'free-casino-games');
  const guideData = getGuide('free-casino-games');
