...
export default async function RngExplainedGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'rng-explained');
  const guideData = getGuide('rng-explained');
