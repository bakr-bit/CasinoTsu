...
export default async function N3ThingsPokerWinnersDoGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', '3-things-poker-winners-do');
  const guideData = getGuide('3-things-poker-winners-do');
