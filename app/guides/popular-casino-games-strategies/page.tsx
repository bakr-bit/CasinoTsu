...
export default async function PopularCasinoGamesStrategiesGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'popular-casino-games-strategies');
  const guideData = getGuide('popular-casino-games-strategies');
