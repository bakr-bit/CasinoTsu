...
export default async function FreerollStrategiesGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'freeroll-strategies');
  const guideData = getGuide('freeroll-strategies');
