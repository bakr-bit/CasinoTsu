...
export default async function SowqDocumentsGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'sowq-documents');
  const guideData = getGuide('sowq-documents');
