...
export default async function HoleCardRankingGuidesPage() {
  const { content, frontmatter } = await loadMDX('guides', 'hole-card-ranking');
  const guideData = getGuide('hole-card-ranking');
