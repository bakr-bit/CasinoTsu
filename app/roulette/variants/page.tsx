...
export const metadata: Metadata = {
  ...
  description: "オンラインカジノで楽しめるルーレットの種類、特徴、選び方を日本人向けに徹底解説。ヨーロピアン、フレンチ、アメリカンルーレットの違いから、ライブルーレット、ライトニングルーレットなどのオンラインならではのバリエーション、決済方法、安全性まで、ルーレットを始める前に知っておきたい情報を網羅しています。",
};

export default async function VariantsRoulettePage() {
  const { content, frontmatter } = await loadMDX('roulette', 'variants');
  const rouletteData = getRoulette('variants');
