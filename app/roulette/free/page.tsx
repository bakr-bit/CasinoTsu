...
export const metadata: Metadata = {
  ...
  description: "2025年最新版の日本人向け無料オンラインルーレット完全ガイド。合法性、メリット・デメリット、遊び方、CasinoTsuおすすめの安全なカジノ選びのポイントを詳しく解説します。",
};

export default async function FreeRoulettePage() {
  const { content, frontmatter } = await loadMDX('roulette', 'free');
  const rouletteData = getRoulette('free');
