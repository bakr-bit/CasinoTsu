...
export default async function RoobetWelcomeOfferOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'roobet-welcome-offer');
  const offerData = getOffer('roobet-welcome-offer');
