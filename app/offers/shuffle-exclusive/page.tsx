...
export default async function ShuffleExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'shuffle-exclusive');
  const offerData = getOffer('shuffle-exclusive');
