...
export default async function IntercasinoWelcomeOfferOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'intercasino-welcome-offer');
  const offerData = getOffer('intercasino-welcome-offer');
