...
export default async function JoycasinoExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'joycasino-exclusive');
  const offerData = getOffer('joycasino-exclusive');
