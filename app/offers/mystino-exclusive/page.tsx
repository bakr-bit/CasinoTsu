...
export default async function MystinoExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'mystino-exclusive');
  const offerData = getOffer('mystino-exclusive');
