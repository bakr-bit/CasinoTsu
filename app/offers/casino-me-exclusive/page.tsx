...
export default async function CasinoMeExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'casino-me-exclusive');
  const offerData = getOffer('casino-me-exclusive');
