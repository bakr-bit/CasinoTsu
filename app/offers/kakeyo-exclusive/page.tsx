...
export default async function KakeyoExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'kakeyo-exclusive');
  const offerData = getOffer('kakeyo-exclusive');
