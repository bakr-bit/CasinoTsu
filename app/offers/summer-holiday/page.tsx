...
export default async function SummerHolidayOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'summer-holiday');
  const offerData = getOffer('summer-holiday');
