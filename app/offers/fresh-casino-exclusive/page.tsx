...
export default async function FreshCasinoExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'fresh-casino-exclusive');
  const offerData = getOffer('fresh-casino-exclusive');
