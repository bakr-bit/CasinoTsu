...
export default async function VeraJohnExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'vera-john-exclusive');
  const offerData = getOffer('vera-john-exclusive');
