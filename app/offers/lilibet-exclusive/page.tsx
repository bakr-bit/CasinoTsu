...
export default async function LilibetExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'lilibet-exclusive');
  const offerData = getOffer('lilibet-exclusive');
