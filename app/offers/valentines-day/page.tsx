...
export default async function ValentinesDayOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'valentines-day');
  const offerData = getOffer('valentines-day');
