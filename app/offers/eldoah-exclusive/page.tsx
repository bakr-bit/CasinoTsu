...
export default async function EldoahExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'eldoah-exclusive');
  const offerData = getOffer('eldoah-exclusive');
