...
export default async function KonibetExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'konibet-exclusive');
  const offerData = getOffer('konibet-exclusive');
