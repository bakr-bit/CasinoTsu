...
export default async function RamenbetExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'ramenbet-exclusive');
  const offerData = getOffer('ramenbet-exclusive');
