...
export default async function TrustdiceExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'trustdice-exclusive');
  const offerData = getOffer('trustdice-exclusive');
