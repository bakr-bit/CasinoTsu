...
export default async function BetpandaExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'betpanda-exclusive');
  const offerData = getOffer('betpanda-exclusive');
