...
export default async function ShinqueenNoDepositBonusOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'shinqueen-no-deposit-bonus');
  const offerData = getOffer('shinqueen-no-deposit-bonus');
