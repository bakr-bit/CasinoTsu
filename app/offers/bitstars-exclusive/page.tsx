...
export default async function BitstarsExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'bitstars-exclusive');
  const offerData = getOffer('bitstars-exclusive');
