...
export default async function BetrebelsExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'betrebels-exclusive');
  const offerData = getOffer('betrebels-exclusive');
