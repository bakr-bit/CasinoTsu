...
export default async function CasinoSkyExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'casino-sky-exclusive');
  const offerData = getOffer('casino-sky-exclusive');
