...
export default async function WinzIoExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'winz-io-exclusive');
  const offerData = getOffer('winz-io-exclusive');
