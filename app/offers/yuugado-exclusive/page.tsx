...
export default async function YuugadoExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'yuugado-exclusive');
  const offerData = getOffer('yuugado-exclusive');
