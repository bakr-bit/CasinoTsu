...
export default async function WonderCasinoExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'wonder-casino-exclusive');
  const offerData = getOffer('wonder-casino-exclusive');
