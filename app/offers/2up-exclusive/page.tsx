...
export default async function N2upExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', '2up-exclusive');
  const offerData = getOffer('2up-exclusive');
