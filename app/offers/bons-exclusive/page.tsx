...
export default async function BonsExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'bons-exclusive');
  const offerData = getOffer('bons-exclusive');
