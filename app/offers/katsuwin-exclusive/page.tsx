...
export default async function KatsuwinExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'katsuwin-exclusive');
  const offerData = getOffer('katsuwin-exclusive');
