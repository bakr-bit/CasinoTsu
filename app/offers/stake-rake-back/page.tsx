...
export default async function StakeRakeBackOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'stake-rake-back');
  const offerData = getOffer('stake-rake-back');
