...
export default async function DuelbitsExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'duelbits-exclusive');
  const offerData = getOffer('duelbits-exclusive');
