...
export const metadata: Metadata = {
  ...
  description: "CasinoTsu限定で、入金不要ボーナスをお受け取りいただけます。初心者の方にも強くお勧めしたい、元祖キャッシュバックカジノ『カジノシークレット』からの特別なオファーです CasinoTsu限定ボーナスで、無料でのスタートダッシュをお楽しみください",
};

export default async function CasinoSecretExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'casino-secret-exclusive');
  const offerData = getOffer('casino-secret-exclusive');
