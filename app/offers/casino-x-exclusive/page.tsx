...
export const metadata: Metadata = {
  title: "【Casino-X】CasinoTsu限定！入金不要ボーナスで、カジノ体験を始めましょう。",
  description: "Casino-X（カジノエックス）で、¥4,500の入金不要ボーナスを活用し、お得にプレイを始めませんか？ CasinoTsu が、その詳細をご案内いたします。",
};

export default async function CasinoXExclusiveOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'casino-x-exclusive');
  const offerData = getOffer('casino-x-exclusive');
