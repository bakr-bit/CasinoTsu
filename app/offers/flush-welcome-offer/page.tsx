...
export default async function FlushWelcomeOfferOffersPage() {
  const { content, frontmatter } = await loadMDX('offers', 'flush-welcome-offer');
  const offerData = getOffer('flush-welcome-offer');
