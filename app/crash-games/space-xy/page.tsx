...
export default async function SpaceXyCrashGamesPage() {
  const { content, frontmatter } = await loadMDX('crash-games', 'space-xy');
  const crashGameData = getCrashGame('space-xy');
